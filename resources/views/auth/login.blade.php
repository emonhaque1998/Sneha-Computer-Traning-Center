...
@section('bodyStyle', "background-image: url('assets/images/p-1.png'); background-size: cover; background-position: center center;")
@section("content")
    <!-- Log In page -->
                                     ...
                                     <form  method="POST" action="{{ route('login') }}" class="my-4">            
                                        ...
                                        <div class="form-group mb-2">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input type="password" class="form-control" name="password" id="password" placeholder="Enter password"  type="password"
                                             name="password"
                                             ...
                                             <div class="col-sm-6 text-end">
                                                @if (Route::has('password.request'))
                                                    <a class="text-muted font-13" href="{{ route('password.request') }}">
                                                        Forgot password?<i class="dripicons-lock"></i>
                                                    </a>
                                                @endif                               
                                             </div><!--end col--> 
                                         </div><!--end form-group--> 
